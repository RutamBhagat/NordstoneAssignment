...
export async function POST(request: NextRequest) {
  ...
  let info = await transporter.sendMail({
    ...
    <body>
        ...
        <ol>
            <li>Click on the password reset link at <a href="https://nordstone-assignment.vercel.app/auth/forgot_password?token=${token}">Reset Password Vercel</a></li>
            <li>or <a href="http://localhost:3000/auth/forgot_password?token=${token}">Reset Password Localhost</a></li>
